...
function Loader() {
  return (
    <div className="min-w-screen min-h-[screen] bg-wedir bg-no-repeat flex justify-center">
      ...
      <div className="flex w-full h-1/12 justify-around mx-auto items-center my-4">
        <div className=" min-w-1/2 flex justify-center">
          <div className="w-72 h-8 bg-slate-300 animate-pulse rounded-xl"></div>
        </div>
      </div>
      <div className="flex w-full h-1/4 justify-around mx-auto items-center ">
        <div className="w-1/2">
          <div className="w-40 h-36 bg-slate-300 animate-pulse rounded-xl mx-auto"></div>
        </div>
      ...
      <div className="flex w-full h-1/6 justify-around mx-auto items-center ">
        <div className=" flex w-1/2 ml-10 justify-center sm:ml-1 ">
          <div className="w-40 h-8 bg-slate-300 animate-pulse rounded-xl mx-auto"></div>
        </div>
      ...
      <div className="flex w-full h-1/6 justify-around mx-auto items-center sm:my-4">
        <div className=" flex w-1/3 justify-center">
          <div className="w-32 h-8 bg-slate-300 animate-pulse rounded-xl mx-auto"></div>
        </div>
        <div className=" flex w-1/3 justify-center">
          <div className="w-32 h-8 bg-slate-300 animate-pulse rounded-xl mx-auto"></div>
        </div>
      ...
      <div className="flex w-full h-1/3 flex-col lg:h-1/4 items-center">
        ...
        <div className="w-60 h-32 bg-slate-300 animate-pulse rounded-xl mx-auto"></div>
      ...
      <div className="w-full h-1/10 my-5 flex justify-center items-center">
        <div className="w-60 h-8 bg-slate-300 animate-pulse rounded-xl mx-auto"></div>
      </div>
